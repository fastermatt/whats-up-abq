  ...
  return (
    <CuratedListPage
      ...
      config={{
        ...
        intro: 'You want live music in Albuquerque on a Wednesday. Not a Saturday. Saturday is for tourists and people who plan ahead. Wednesday? That’s when the actual scene breathes. I’ve walked into Launchpad on a Tuesday and caught a local band that had no business being that tight. Sister Bar on a Wednesday night is a lottery ticket. Sometimes you get a DJ who thinks they’re at Coachella. Other times you get a punk trio that reminds you why you moved here. The best shows don\'t have a cover. They don\'t have a listing on some polished website. They\'re on a chalkboard outside a bar on Central. Or they\'re at a house venue that you swear is someone\'s garage but it\'s got a PA system and a fridge full of PBR. The thing about Albuquerque music? It\'s scrappy. It\'s loud when it wants to be. It\'s quiet when it\'s a solo acoustic set at the Cellar Door. You learn to follow the local booking pages on Instagram. You learn that Sunday afternoon at Back Alley Draft House is actually a secret jazz brunch. And you learn that if you wait for the weekend, you\'ll miss half the good stuff. Don\'t wait. Go on a Wednesday. You might even find me there, nursing a beer and nodding along.',
