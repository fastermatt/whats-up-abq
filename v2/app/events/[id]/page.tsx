...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  // OG image is dynamically generated by `opengraph-image.tsx` (sibling file).
  // Next.js auto-detects that file and emits `<meta og:image>` pointing at the
  // generated PNG, so we don't need to set images here.
  return {
