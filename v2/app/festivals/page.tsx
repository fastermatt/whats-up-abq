  ...
  return (
    <CuratedListPage
      ...
      config={{
        ...
        venueStrip: [
          { name: 'New Mexico State Fair',       emoji: '🎡', href: 'https://www.exponm.com' },
          { name: 'Civic Plaza',                 emoji: '🏛️', href: 'https://www.cabq.gov/culturalservices/kimo' },
          { name: 'Albuquerque Convention Ctr',  emoji: '🎪' },
