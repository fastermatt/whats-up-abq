  ...
  return (
    <CuratedListPage
      ...
      config={{
        ...
        intro:
          "The nice thing about Albuquerque is that something is almost always happening. Not in a New York way, where the options are so overwhelming you end up staying home. In an ABQ way, where there are enough things going on that you can actually find something, go to it, and feel like you made a good call.\n\nToday's list is what we know about right now. It updates throughout the day as venues post lineups, as libraries confirm their afternoon programs, as last-minute show announcements hit Eventbrite and Ticketmaster.\n\nThe morning usually starts with outdoor stuff: the Bosque Trail, the Petroglyph trailheads, Elena Gallegos if you want a real hike. By afternoon, the museum and library circuit opens up. By evening, the music and comedy venues come alive.\n\nWe track all of it: Ticketmaster, SeatGeek, Eventbrite, local community calendars, library systems, volunteer-organized events. If it's happening in Albuquerque today and it's worth your time, it's above. Use the category chips to filter down to what matters to you, whether that's live music, something free, family-friendly, or a sports event.",
