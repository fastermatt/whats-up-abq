    ...
    >
      ...
      <div className={embedded
        ...
        >
          ...
          {/* Image loading shimmer — solid block between img and gradient.
              No animate-pulse: opacity cycling caused a blink where the partially-loaded
              image bled through the gradient. Stays below the gradient so text stays
              visible (text divs follow gradient in DOM and render on top). */}
          {!imageLoaded && (
