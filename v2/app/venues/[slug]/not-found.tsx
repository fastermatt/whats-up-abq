...
export default function VenueNotFound() {
  return (
    <main className="min-h-dvh bg-[--bg] flex flex-col items-center justify-center px-4 py-16 text-center">
      ...
      <p className="text-sm text-[#8a7a74] mb-6">No upcoming events found at this venue.</p>
      <Link
        href="/events"
