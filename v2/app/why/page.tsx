    ...
    <main id="main" className="min-h-dvh bg-cream">
      ...
      <article className="max-w-2xl mx-auto px-4 py-10 prose prose-sm">
        <AnimateIn animation="fade-up">
          <p className="text-[10px] uppercase tracking-[0.25em] text-terra font-semibold mb-2">
            Why this site exists
          </p>
          <h1
            className="text-3xl sm:text-4xl font-black text-ink leading-[1.05] mb-6"
        ...
        <AnimateIn animation="fade-up" delay={160}>
          <h2
            className="text-xl font-black text-ink mt-8 mb-3"
            style={{ fontFamily: 'var(--font-epilogue)' }}
          >
          ...
          <div className="space-y-5 mb-8">
            <div>
              <p className="text-sm font-bold text-terra mb-1">Relationships are the longest-studied thing in happiness research.</p>
            ...
            <div>
              <p className="text-sm font-bold text-terra mb-1">Americans spend 20 minutes a day with friends.</p>
              <p className="text-sm text-ink-mid leading-relaxed">
            ...
            <div>
              <p className="text-sm font-bold text-terra mb-1">Weak ties matter more than we think.</p>
              <p className="text-sm text-ink-mid leading-relaxed">
            ...
            <div>
              <p className="text-sm font-bold text-terra mb-1">Social fitness is a practice.</p>
              <p className="text-sm text-ink-mid leading-relaxed">
            ...
            <div>
              <p className="text-sm font-bold text-terra mb-1">Showing up is half of belonging.</p>
              <p className="text-sm text-ink-mid leading-relaxed">
        ...
        <AnimateIn animation="fade-up" delay={240}>
          <h2
            className="text-xl font-black text-ink mt-10 mb-3"
            style={{ fontFamily: 'var(--font-epilogue)' }}
          >
          ...
          <ul className="space-y-2 mb-8 list-none pl-0">
            <li className="text-sm text-ink-mid leading-relaxed">
              <span className="text-terra font-bold mr-2">&middot;</span>
        ...
        <AnimateIn animation="fade-up" delay={320}>
          <div className="border-t border-sand-light pt-6 mt-10 mb-8">
        ...
        <AnimateIn animation="fade-up" delay={400}>
          <div className="flex flex-wrap gap-3 mb-10">
            <Link
              ...
              className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full bg-terra text-white text-sm font-semibold hover:bg-terra-hover transition-colors"
            >
            ...
            <Link
              href="/api/surprise"
              className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full border border-sand-mid text-sm font-semibold text-ink-mid hover:border-terra hover:text-terra transition-colors"
            >
              Surprise me
            </Link>
          </div>
